...
def parse_args():
    ...
    parser.add_argument('--num-bot-envs', type=int, default=16,
    ...
    parser.add_argument('--train-maps', nargs='+', default=["maps/8x8/light_only_8x8.xml"],
        help='the list of maps used during training')
    ...
    parser.add_argument('--eval-maps', nargs='+', default=["maps/8x8/light_only_8x8.xml"],
        help='the list of maps used during evaluation')
