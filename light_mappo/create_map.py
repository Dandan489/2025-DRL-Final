...
save_folder = "MicroRTS-Py\\gym_microrts\\microrts\\maps"


class MapVisualizer:
    def __init__(self, path):
        self.path = os.path.join("maps", path)
        print(f"saving map at {self.path}")
...
class MapGenerator:
    ...
    def __init__(self, path, H, W):
        self.saved_path = os.path.join(save_folder, path)
