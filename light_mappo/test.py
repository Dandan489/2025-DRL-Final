...
import torch
import gym_microrts.microrts_ai as microrts_ai
...
def main(args):
    ...
    all_args.n_eval_rollout_threads = envs.env.num_envs if all_args.use_eval else None
